...
# 2. CSS PARA FUNDO BRANCO E ESTILIZAÇÃO
st.markdown("""
    <style>
    .stApp {
...
with col1:
    ...
    # 1º Campo: ID do Anúncio (MLB)
    id_anuncio = st.text_input("ID do Anúncio (MLB)", placeholder="Ex: MLB123456789")
    
    # 2º Campo: Preço de Custo (Aceitando vírgula)
